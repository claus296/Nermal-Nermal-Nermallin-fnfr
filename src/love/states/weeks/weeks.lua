...
return {
	...
	initUI = function(self)
		...
		for i = 1, 4 do
			if week ~= 5 then
				...
				boyfriendArrows[1].x = -575 + 165 * 1
				boyfriendArrows[2].x = -575 + 165 * 2
				boyfriendArrows[3].x = -250 + 165 * 3
				boyfriendArrows[4].x = -250 + 165 * 4
				leftArrowSplash.x = -590 + 165 * 1 + 5
				downArrowSplash.x = -590 + 165 * 2 + 5
				upArrowSplash.x = -265 + 165 * 3 + 5
				rightArrowSplash.x = -265 + 165 * 4 + 5
			end
			...
			if week == 5 then
				leftArrowSplash.y = -420
				downArrowSplash.y = -420
				upArrowSplash.y = -420
				rightArrowSplash.y = -420
			end
	...
	--camTimer = Timer.tween(1.25, cam, {x = -boyfriend.x + 200, y = -boyfriend.y + 20}, "out-quad")
	--camTimer = Timer.tween(1.25, cam, {x = -boyfriend.x + 100, y = -boyfriend.y + 75}, "out-quad")
