...
return {
	enter = function(self, previous)
		...
		enemyDanceLines = love.filesystem.load("sprites/menu/nermLines.lua")()
		...
		--week images 
		weekImages = graphics.newImage(love.graphics.newImage(graphics.imagePath("menu/week0")))
	...
	update = function(self, dt)
		...
		elseif songDifficulty == 2 then
			difficultyAnim:animate("gay", true)
		end
